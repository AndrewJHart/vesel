...
#
# Note: this version works with Backbone.js but you can easily mix it in to any 
# 		preferred extensions/frameworks like marionette or chaplin by simply using 
#		their version of the backbone events aggregator
#				remove call to console, Chaplin and mixin Backbone's original events
